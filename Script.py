import os
class script(object):
    START_TXT = """<b>➠ Hey {}, {}\n▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▰\n〄 Movie's Group Bot Is at your service!\n\n𓊝 Send the name of any movie, series, or anime to get the files.\n▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▰\n<blockquote>𖤍 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/MoviesGroupG3">Movies Group</a></blockquote></b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/bambhaniya_jagdish_79'>Jagdish</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : Movie's Group Bot\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/bambhaniya_jagdish_79'>Jagdish</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n\n\n𝖩𝗈𝗂𝗇➥ 「<a href="https://t.me/MoviesGroupG3">Movies Group</a>」</b>"""
...
12 Month 100 Rupees
 ...
 <code>yashkamaliya95@okicici</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/bambhaniya_jagdish_79'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/bambhaniya_jagdish_79/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- How to use Bot ◉› :<blockquote><a href="https://t.me/MoviesGroupG3">Movies Group</a></blockquote>
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/bambhaniya_jagdish_79">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/bambhaniya_jagdish_79">ᴀᴅᴍɪɴ</a></b>"""
